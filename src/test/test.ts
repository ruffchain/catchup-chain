...
import { getTokenBalance, prnGetTokenBalance } from '../api/getTokenBalance';
import { getBlock, prnGetBlock } from '../api/getblock';
import { getCandidates, prnGetCandidates } from '../api/getCandidates';
import { getMiners, prnGetMiners } from '../api/getminers';
import { getPeers, prnGetPeers } from '../api/getpeers';
import { getReceipt, prnGetReceipt } from '../api/getreceipt';
import { createBancorToken } from '../api/createBancorToken';
import { getBancorTokenBalance, prnGetBancorTokenBalance } from '../api/getBancorTokenBalance';
import { transferBancorTokenTo } from '../api/transferBancorTokenTo';
...
import { buyBancorToken } from '../api/buyBancorToken';
import { sellBancorToken } from '../api/sellBancorToken';
