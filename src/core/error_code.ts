...
export enum ErrorCode {
    ...
    RESULT_SYNC_GETBUYTOKENCOST_FAILED = 11312,
    RESULT_SYNC_GETSELLTOKENGAIN_FAILED = 11313,

    RESULT_SYNC_GETTXSTRANSFERTO_FAILED = 11320,
    RESULT_SYNC_GETTXSTRANSFERFROM_FAILED = 11321,
